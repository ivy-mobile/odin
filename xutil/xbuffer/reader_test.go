...
func TestReader(t *testing.T) {
	...
	reader := xbuffer.NewReader(writer.Bytes())
...
func BenchmarkReader(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		_, _ = reader.ReadBool()
		_, _ = reader.ReadInt8()
		_, _ = reader.ReadUint8()
		_, _ = reader.ReadInt16(binary.BigEndian)
		_, _ = reader.ReadUint16(binary.BigEndian)
		_, _ = reader.ReadInt32(binary.BigEndian)
		_, _ = reader.ReadUint32(binary.BigEndian)
		_, _ = reader.ReadInt64(binary.BigEndian)
		_, _ = reader.ReadUint64(binary.BigEndian)
		_, _ = reader.ReadFloat32(binary.BigEndian)
		_, _ = reader.ReadFloat64(binary.BigEndian)
		_, _ = reader.ReadRune(binary.BigEndian)
		_, _ = reader.ReadByte()
		_, _ = reader.ReadString(11)
		reader.Reset()
	}
}
...
func BenchmarkBinaryRead(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		_ = binary.Read(reader, binary.BigEndian, &v1)
		_ = binary.Read(reader, binary.BigEndian, &v2)
		_ = binary.Read(reader, binary.BigEndian, &v3)
		_ = binary.Read(reader, binary.BigEndian, &v4)
		_ = binary.Read(reader, binary.BigEndian, &v5)
		_ = binary.Read(reader, binary.BigEndian, &v6)
		_ = binary.Read(reader, binary.BigEndian, &v7)
		_ = binary.Read(reader, binary.BigEndian, &v8)
		_ = binary.Read(reader, binary.BigEndian, &v9)
		_ = binary.Read(reader, binary.BigEndian, &v10)
		_ = binary.Read(reader, binary.BigEndian, &v11)
		_ = binary.Read(reader, binary.BigEndian, &v12)
		_ = binary.Read(reader, binary.BigEndian, &v13)
		_ = binary.Read(reader, binary.BigEndian, &v14)
