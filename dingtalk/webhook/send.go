...
func SendSingleActionCard(ctx context.Context, webhook, title, text, singleTitle, singleURL string, orientation BtnOrientation, opts ...Option) error {
...
func SendActionCard(ctx context.Context, webhook, title, text string, btns []ActionCardButton, orientation BtnOrientation, opts ...Option) error {
