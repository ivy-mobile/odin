...
func (x *Member) GetMeta() map[string]*Value {
	if x != nil {
		return x.Meta
	}
	return nil
...
const file_member_proto_rawDesc = "" +
	"\n" +
	"\fmember.proto\x12\benvelope\x1a\vvalue.proto\"\x94\x02\n" +
	"\x06Member\x12\x10\n" +
...
var file_member_proto_goTypes = []any{
	(*Member)(nil), // 0: envelope.Member
	nil,            // 1: envelope.Member.MetaEntry
	(*Value)(nil),  // 2: envelope.Value
}
var file_member_proto_depIdxs = []int32{
	1, // 0: envelope.Member.meta:type_name -> envelope.Member.MetaEntry
	2, // 1: envelope.Member.MetaEntry.value:type_name -> envelope.Value
